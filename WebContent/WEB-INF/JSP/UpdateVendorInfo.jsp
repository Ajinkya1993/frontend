...
<!-- *********Starts Here************ -->
			...
			<h3 class="main-heading1"><center><b/>Update Vendor's Information</center></h3>
			<c:forEach var="error" items="${errors}">
				<h5 style="color:red" align="center"> ${error} </h5>
			</c:forEach>
			
			<div class="col-sm-6">
					<form action="updatevendorinfo.do" method="POST">
							<div class="form-group">
							<div class="form-group">
								<label>Vendor Name:</label>
								<input type="text" name="vendorName" class="form-control" value="${vendorName}">
							</div>
							<div class="form-group">
								<label>Vendor Website:</label>
								<input type="text" name="vendorWebsite" class="form-control" value="${vendorWebsite}">
							</div>
							<div class="form-group">
								<label>Vendor Account:</label>
								<input type="text" name="vendorAccount" class="form-control" value="${vendorAccount}">
							</div>
							<div class="form-group">
								<label>Vendor Address:</label>
								<input type="text" name="vendorAddress" class="form-control" value="${vendorAddress}">
							</div>
							<div class="form-group">
								<label>Expenses:</label>
								<input type="text" name="expenses" class="form-control" value="${expenses}">
							</div>
		    				</div>
								<input type="submit" name="action" class="btn btn-lg btn-info" value="Update Info" />
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	
								<input type="submit" name="action" class="btn btn-lg btn-info" value="View Expenses" />			
					</form>
					</div>
			</div>
