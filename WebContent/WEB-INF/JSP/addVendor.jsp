...
<!-- *********Starts Here************ -->
			...
			<h3 class="main-heading1"><center><b/>Add Vendor</center></h3>
			...
			<div class="col-sm-6">
					<form action="createteam.do" method="POST">
							...
							<div class="form-group">
								...
								<input type="url" name="lovefirstname" class="form-control">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>Number of Recurring Payments to be made:</label>
							...
							<div class="form-group">
								...
								<input type="submit" name="action" class="btn btn-lg btn-info" value="Add Vendor" />			
					</form>
					</div>
		    <div class="col-sm-3">
			</div>
